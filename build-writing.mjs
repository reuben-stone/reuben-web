...
const SHARED_CSS = `
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .mobile-nav {
      ...
      border-bottom: 1px solid var(--border);
      background: var(--bg);
      animation: navReveal 0.2s ease-out;
    }
  ...
  return `<header class="header">
    <div class="container">
      ...
      <nav aria-label="Main navigation">
        <button class="mobile-toggle" aria-expanded="false" onclick="var n=document.getElementById('mobile-nav');var o=n.classList.toggle('open');this.setAttribute('aria-expanded',o);this.textContent=o?'Close':'Menu'">Menu</button>
    ...
    <div class="mobile-nav" id="mobile-nav">
      <div class="container">
        <ul class="mobile-nav-links">
          <li><a href="/">Work</a><span class="mobile-nav-index">01</span></li>
          <li><a href="/writing/"${activeSection === 'writing' ? ' style="color: var(--accent);"' : ''}>Writing</a><span class="mobile-nav-index">02</span></li>
          <li><a href="/#about">About</a><span class="mobile-nav-index">03</span></li>
        </ul>
