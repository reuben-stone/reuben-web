...
const SHARED_CSS = `
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    @media (max-width: 768px) {
      ...
      body.nav-open .mobile-toggle { visibility: hidden; }
      body.nav-open .header-name { visibility: hidden; }
    }
`
  ...
  return `<header class="header">
    ...
    <div class="mobile-nav" id="mobile-nav">
      <div class="mobile-nav-header">
        <a href="/" class="mobile-nav-brand">Reuben Stone</a>
        <button class="mobile-nav-close" onclick="document.getElementById('mobile-nav').classList.remove('open');document.body.classList.remove('nav-open');document.querySelector('.mobile-toggle').textContent='Menu';document.querySelector('.mobile-toggle').setAttribute('aria-expanded','false')">Close</button>
      </div>
